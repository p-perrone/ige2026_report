...
When looking at sub-daily variability in albedo spectra, we noticed that in many cases this is not converging to 1 in the visible, yielding instead values around 1.2, too high. 
