...
\begin{figure}
	\centering
	\includegraphics[width=16cm]{era5_vs_cnr4.pdf}
...
Solalb records can be processed analogously to Multiband ones. Cross-calibration is not performed, as there is only one light collector on the head. Each experiment reports a quality tag (A+, A, B, C) indicating the consistency of spectra throughout the experiment, depending on light conditions. Only A and A+ records are selected, with less than 10\% internal variability between the ten upward and downward measurements.
