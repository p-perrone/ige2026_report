...
The pipeline for processing Multiband data is summarized in Figure \ref{fig:mbwf} and results from the work of \cite{arioliDynamicsSnowGrain2023}. It executes functions from a custom Python library specifically developed for this purpose, plus utilities from the open source module \texttt{snowptics} (\href{https://github.com/ghislainp/snowoptics}{GitHub}), a library of function for the retrieval of snow optical properties based on the Asymptotic Radiative Transfer theory (ART, \cite{kokhanovskyScatteringOpticsSnow2004})
...
\part{Results}
	...
	\section{Atmospheric conditions: emissivity analyisis}
