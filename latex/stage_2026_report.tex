...
\begin{enumerate}
	...
	\item \textbf{Processing of Sentinel-3 data}: downloading and executing the SICE 1.6 algorithm, as described by \cite{kokhanovskyRetrievalSnowProperties2019};
	\item \textbf{Comparison of the time series}: analyzing corrections to address gaps between the two datasets and interpreting the retrieved albedo dynamics geoscientifically.
\end{enumerate}
